...
int BSP_CAM_Init(void);
int	BSP_CAM_read(const char *cmd,unsigned char lenth,unsigned char** rev);
int	BSP_CAM_write(const char *cmd,unsigned char lenth,unsigned char** rev);
